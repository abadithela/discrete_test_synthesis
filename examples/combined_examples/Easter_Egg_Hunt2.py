...
# Same as Easter Egg Hunt but modifying the goal location a lot
import numpy as np
import random
...
def run_easter_egg_example():
    ...
    def compute_env_winning_set(coverage_props_list):
        ...
        # Look backward only from the last proposition to be covered in sequence
        goal_vertices = Game_Graph.set_win_states([env_goal_nodes[0]])
        # Robust Pre for system winning set computation:
        quant_env = 'exists'
        quant_sys = 'exists'
        win_agent = 'e'
